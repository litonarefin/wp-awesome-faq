...
?>
	<div class="wrap <?php if ( !jltwpafaq_license_client()->can_use_premium_code() ) { echo 'jltmaf-disabled'; }?>">
...
<?php
	if ( !jltwpafaq_license_client()->can_use_premium_code() ) {
		echo '<span class="jltmaf-pro-feature"> Upgrade to  <a href="' . jltwpafaq_license_client()->get_upgrade_url() . '">Pro Version</a> unlock this feature.</span>';
	}
}
