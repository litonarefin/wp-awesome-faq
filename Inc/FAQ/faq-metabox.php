...
function jltmaf_customizer_meta_box() {
	add_meta_box( 
		'jw_faq_customizer', 
		__( 'FAQ Item Customize', 'wp-awesome-faq' ), 
...
function jltmaf_customizer_callback( $post ) {
	...
	<div class="jltmaf-container">
		...
		<h5 class="faq-customizer-title">
			<?php _e( 'Close Icon', 'wp-awesome-faq' )?>		
		</h5>
		
		<p class="<?php if ( !jltwpafaq_license_client()->can_use_premium_code() ) { echo 'jltmaf-disabled'; }?>">
			<select id="jltmaf_mb_close_icon" name="close_icon" class="jltmaf-fonticon-pickers ">
				<option value=""><?php echo __('No icon', 'wp-awesome-faq');?></option>
				<?php 
			...
			<?php 	if ( !jltwpafaq_license_client()->can_use_premium_code() ) {
			echo '<div class="jltmaf-text-small"> Upgrade to  <a href="' . jltwpafaq_license_client()->get_upgrade_url() . '">Pro Version</a> unlock this feature.</div>';
			} ?>
		</p>
		...
		<h5 class="faq-customizer-title">
			<?php _e( 'Open Icon', 'wp-awesome-faq' )?>		
		</h5>
		...
		<div class="left-half">
			<h5 class="faq-customizer-title">
				<?php _e( 'Title Background Color', 'wp-awesome-faq' )?>		
			</h5>
		</div>

		<div class="right-half <?php if ( !jltwpafaq_license_client()->can_use_premium_code() ) { echo 'jltmaf-disabled'; }?>">
			<p>
		...
		<div class="left-half">
			<h5 class="faq-customizer-title">
				<?php _e( 'Title Color', 'wp-awesome-faq' )?>
			</h5>
		</div>
		<div class="right-half <?php if ( !jltwpafaq_license_client()->can_use_premium_code() ) { echo 'jltmaf-disabled'; }?>">
			<p>
		...
		<div class="left-half">
			<h5 class="faq-customizer-title">
				<?php _e( 'Content Background Color', 'wp-awesome-faq' )?>
			</h5>
		</div>
		<div class="right-half <?php if ( !jltwpafaq_license_client()->can_use_premium_code() ) { echo 'jltmaf-disabled'; }?>">		
			<p>
		...
		<h5 class="faq-customizer-title">
			<?php _e( 'Content Text Color', 'wp-awesome-faq' )?>		
		</h5>
		...
		<h5 class="faq-customizer-title">
			<?php _e( 'Content Border Color', 'wp-awesome-faq' )?>		
		</h5>
