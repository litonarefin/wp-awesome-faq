<?php
namespace JLTWPAFAQ\Inc\FAQ\Elementor\Addon;
...
if ( ! defined( 'ABSPATH' ) ) { exit; }
 ...
 class Master_Accordion extends Widget_Base {
	...
	public function get_title() {
		return __( 'Master Accordion', 'wp-awesome-faq' );
	}
    ...
    protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Content', 'wp-awesome-faq' ),
			]
        );
        ...
        $this->add_control(
            'jltmaf_faq_cats',
            [
                'label'                 => esc_html__( 'Category', 'wp-awesome-faq' ),
        ...
        $this->add_control(
            'jltmaf_faq_tags',
            [
                'label'                 => esc_html__( 'Tags', 'wp-awesome-faq' ),
                'type'                  => Controls_Manager::SELECT,
                'label_block'           => false,
        ...
        $this->add_control(
            'jltmaf_faq_items',
            [
                'label'                 => esc_html__( 'No. of Items', 'wp-awesome-faq' ),
                'type'                  => Controls_Manager::NUMBER,
                'label_block'           => false,
                'default'               => -1,
                'frontend_available'    => true,
                'description'           => esc_html__( 'Define no. of posts. "-1" for all posts.', 'wp-awesome-faq' ),
            ]
        );
        ...
        $this->add_control(
            'jltmaf_faq_order',
            [
                'label'                 => esc_html__( 'Order', 'wp-awesome-faq' ),
                'type'                  => Controls_Manager::SELECT,
                'label_block'           => false,
                'default'               => 'DESC',
                'options'               => [
                    'DESC'      => esc_html__('Descending', 'wp-awesome-faq' ),
                    'ASC'       => esc_html__('Ascending', 'wp-awesome-faq' )
                ],
            ]
        );
    ...
    protected function jltmaf_tags(){
        $cats = array('' => __('All Tags', 'wp-awesome-faq'));
