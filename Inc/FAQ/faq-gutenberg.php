...
if ( ! function_exists( 'jltmaf_register_master_accordion_block' ) ) {
	function jltmaf_register_master_accordion_block(){
		...
		wp_register_style(
			'jltmaf-style', // Handle.
			JLTWPAFAQ_URL . '/inc/gutenberg/dist/blocks.style.build.css',
		...
		wp_register_script(
			'jltmaf-block', // Handle.
			JLTWPAFAQ_URL . '/inc/gutenberg/dist/blocks.build.js',
		...
		wp_register_style(
			...
			JLTWPAFAQ_URL . '/inc/gutenberg/dist/blocks.editor.build.css',
