...
use JLTWPAFAQ\Libs\Recommended;
	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'edit.php?post_type=faq',       // Ex. wp-awesome-faq-settings /  edit.php?post_type=page .
				__( 'Recommended', 'wp-awesome-faq' ),
				__( 'Recommended', 'wp-awesome-faq' ),
				'manage_options',
				'wp-awesome-faq-recommended-plugins',
